## Intro
* Esse API tem como objetivo demonstrar habilidades praticas desenvolvidas através do projeto pessoal culinary-recipe. Aqui foram expressas habilidas como TDD, Modelagem de dados, Princípios SOLID, Clean Code, Modelagem UML, Git, Github, CI/CD, API REST design, Design Pattern, Docker, devOps, AWS e outras.
