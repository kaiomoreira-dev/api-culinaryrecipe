...
import { ListRecipeUseCase } from "../listRecipe/ListRecipeUseCase";
...
describe("Delete recipe UseCase", () => {
  beforeEach(() => {
    ...
    deleteRecipeUseCase = new DeleteRecipeUseCase(recipeRepositoryInMemory);
  });
